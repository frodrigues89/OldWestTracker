...
import FichaScreen, {FichaScreenOptions} from './src/screens/FichaScreen'; //tela da ficha de um mala específico
...
const App = () => {
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions = {({ navigation, route }) => navigationOptions(navigation, route)}>
